...
<link rel="stylesheet" href="../online_library/css/wook_group.css">
    ...
    <title>الهيكل الادارى مكتبة كلية علوم المنوفية</title>
</head>
<body>
<?php
  include ('connect.php');
...
<!-- end -->
	...
	<div class="work_lib">
        <div class="container">
            <div class="title">
                <h3><i class="fa fa-thumb-tack"></i> الهيكل الادارى</h3>
            </div>
			<div class="content">
				<div class="box">
					<img src="../online_library/img/12.jpg" alt="">
					<h3>عميد الكلية</h3>
					<p>الاستاذ الدكتور/عادل عبد الهادى نصار</p>
				</div>
				
				<div class="box">
					<img src="../online_library/img/0.jpg" alt="">
					<h3>وكيل الكلية للدراسات العليا والبحوث العلمية</h3>
					<p>الاستاذ الدكتور/ حسن على عليوة</p>
				</div>
				
				<div class="box">
				<img src="../online_library/img/122.jpg" alt="">
					<h3>مدير المكتبة</h3>
					<p>الاستاذ / خالد ابراهيم عفصة</p>
				</div>

			</div>
			<div>
				<ul>
					<li>الاستاذ / احمد مصطفى عمر (اخصائى مكتبات)</li>
					<li>الاستاذة / شيماء عبد الخالق يوسف (اخصائى مكتبات)</li>
					<li>الاستاذة / ياسمين عبد الرحمن عبد العزيز (اخصائى مكتبات)</li>
					<li>الاستاذ / محمد حسن رشدى (اخصائى مكتبات)</li>
					<li>الاستاذ / عمرو عبد الخالق جودة (مرشد قراء)</li>
					<li>الاستاذة / هناء حسانين (عاملة خدمات)</li>
				</ul>
